...
tree <- read.tree("../iqtree/core_stripped.filtered_polymorphic_sites.fasta.treefile")
...
ggsave(r, width = 8, height = 8, device = cairo_pdf,
       file=file.path('./', paste0("Tree_circ_w_clusters_", Sys.Date(), ".pdf")),
       family = "sans", bg=NA)
```
...
ggsave(r, width = 12, height = 42, device = cairo_pdf,
       file=file.path('./', paste0("Tree_rect_w_clusters_", Sys.Date(), ".pdf")),
       family = "sans", bg=NA)
```
